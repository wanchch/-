...
class QuestionClassifier(object):
	def __init__(self):
		...
		self.disease_path = os.path.join(self.project_dir, "D:\knowledge graph\MedicalKGQA-master\\region_words\diseases.txt")
		self.department_path = os.path.join(self.project_dir, 'D:\knowledge graph\MedicalKGQA-master\\region_words\departments.txt')
		self.check_path = os.path.join(self.project_dir, 'D:\knowledge graph\MedicalKGQA-master\\region_words\checks.txt')
		self.drug_path = os.path.join(self.project_dir, 'D:\knowledge graph\MedicalKGQA-master\\region_words\drugs.txt')
		self.food_path = os.path.join(self.project_dir, 'D:\knowledge graph\MedicalKGQA-master\\region_words\\foods.txt')
		self.symptom_path = os.path.join(self.project_dir, 'D:\knowledge graph\MedicalKGQA-master\\region_words\symptoms.txt')
		self.deny_path = os.path.join(self.project_dir, 'D:\knowledge graph\MedicalKGQA-master\\region_words\deny.txt')
